...
import { Message, Reply } from '@prisma/client'
...
const ReplyCardOwner = ({msg, user}:Props) => {
...
<div className={`relative flex items-start gap-2.5  mb-4`} dir='rtl'>
